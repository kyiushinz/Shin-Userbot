...
PMPERMIT_PIC = os.environ.get(
    "PMPERMIT_PIC") or "https://telegra.ph/file/0a8a098c9d0815d96939a.jpg"
...
BDRL_TEKS_KUSTOM = os.environ.get("SHIN_TEKS_KUSTOM", "")
...
ALIVE_LOGO = os.environ.get(
    "ALIVE_LOGO") or "https://telegra.ph/file/32eeead2aec7a7a28571a.jpg"

# Default .helpme Logo
INLINE_PIC = os.environ.get(
    "INLINE_PIC") or "https://telegra.ph/file/32eeead2aec7a7a28571a.jpg"
...
async def check_alive():
    await bot.send_file(BOTLOG_CHATID, ALIVE_LOGO, caption=f"**ʀᴇʏʏ-ᴜsᴇʀʙᴏᴛ Berhasil Diaktifkan✨**\n━━━━━━━━━━━━━━━━━━━\n❃ **ʙᴏᴛ ᴏꜰ :** {ALIVE_NAME}\n❃ **ʙᴏᴛ ᴠᴇʀ :** 7.0\n━━━━━━━━━━━━━━━━━━━\n❃ **Oᴡɴᴇʀ​ :** @SangDappaa\n❃ **ᴄʜᴀɴɴᴇʟ​ :** @stay_hallal\n━━━━━━━━━━━━━━━━━━━")
    return
            ...
            if event.user_joined or event.user_added:
                ...
                await event.reply(
                    ...
                    buttons=[
                        [
                            Button.url("ʀᴇᴘᴏ​",
                                       "https://github.com/kyiushinz/Shin-Userbot")],
                    ]
                )
...
# ====================================InlineHandler===================================== #
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:
                text = (
                    f"❁ __Saya Adalah Shin Userbot Yang Digunakan Banyak User Telegram__.\n\n"
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:
                text = (
                    ...
                    f"× **Pembaruan Data Untuk Shin Userbot, Command Untuk Pembaruan**.\n"
                    f"⚒Pembaruan Data :\n"
                    f"`.update deploy`\n"
                    f"`update`\n\n"
                    f"© @ZenxMato")
            ...
            if event.query.user_id == uid and query.startswith(
                ...
                result = builder.article(
                    ...
                    buttons=[
                        ...
                        [custom.Button.url(
                            "License",
                            "https://github.com/kyiushinz/Shin-Userbot/LICENSE")],
                    ],
                    link_preview=False,
                )
